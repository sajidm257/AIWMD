...
let personName = "Sajid Ali";
console.log("Hello "+ personName + ", would you like to learn some TypeScript today?");

// 3. Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
let personName2 = "sAjid aLi";
let lowerCaseName: string = personName2.toLocaleLowerCase( );
console.log(lowerCaseName);
let upperCaseName: string =personName2.toUpperCase( );
console.log(upperCaseName);
let titlecaseName: string = personName.replace(/\b\w/g, (char: string) => char.toUpperCase());
console.log(titlecaseName);

// 4. Famous Quote: Find a quote from a famous person you admire. Print the quote and the name of its author. Your output should look something like the following, including the quotation marks:
// Albert Einstein once said, “A person who never made a mistake never tried anything new.”
let famousQuote: string = 'Steve Jobs once said, "Your work is going to fill a large part of your life, and the only way to be truly satisfied is to do what you believe is great work. And the only way to do great work is to love what you do."';
...
let message: string = `${famousPerson} once said, "${famousQuote2}"`;
console.log(message);
...
const names: string[] = ["Ali", "Hasan", "Ahmed", "Arif", "Imran"];
...
const transportationModes: string[] = ["car", "motorcycle", "bicycle", "bus", "train"];
for (const mode of transportationModes) {
    console.log(`I would like to own a ${mode}.`);
}
// 14. Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
const guests: string[] = ["Ali", "Hasan", "Ahmed", "Arif", "Imran"];
...
const guestCantMakeIt: string = "Hasan";
...
const index: number = guests.indexOf(guestCantMakeIt);
if (index !== -1) {
...
let placesToVisit: string[] = ["Tokyo", "Paris", "New York", "Malaysia", "Thailand"];
...
let fruits: string[] = ["Apple", "Banana", "Orange", "Grapes", "Strawberry", "Watermelon"];
...
if (alien_color2 === 'green') {
    ...
    let alien_color2: string = 'red'; // or 'yellow'
}if (alien_color2 === 'green') {
    console.log("Congratulations! You just earned 5 points for shooting the green alien.");
} else {
    console.log("Congratulations! You just earned 10 points for shooting the alien.");
...
let ages: number = 30; // You can change the value of age to test different scenarios
...
// Array of usernames
let usernames: string[] = ["admin", "Ali", "Hasan", "Ahmed", "Arif", "Imran"];
...
let usernames2: string[] = []; // Empty array of usernames
...
let new_users: string[] = ["mike", "sarah", "Alice", "david", "John"];
...
new_users.forEach(new_username => {
    ...
    if (current_users.map(username => username.toLowerCase()).includes(lowercase_new_username)) {
...
function make_great(magicians2: string[]): void {
    for (let i = 0; i < magicians.length; i++) {
        magicians[i] = `the Great ${magicians[i]}`;
    }
}
// Array of magician's names
let magicians2: string[] = ["David Copperfield", "Penn Jillette", "Teller", "Derren Brown"];
...
let magicians3: string[] = ["David Copperfield", "Penn Jillette", "Teller", "Derren Brown"];
// Call make_great function with a copy of the array of magicians' names
let great_magicians3: string[] = make_great2([...magicians3]);
// Call show_magicians to show the original list of magicians
...
show_magicians(great_magicians3);
